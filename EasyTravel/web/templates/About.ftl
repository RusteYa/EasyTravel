        ...
        <nav class="navbar navbar-def navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html" id="logo">Easy travel</a>
                </div>
                ...
                <#if user??>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/profile"><span class="glyphicon glyphicon-user"></span> ${user.profile.name}</a>
                        </li>
            ...
            <div id="main_soc_block">
                <center>
                    <div id="main_soc_block_in">
                        <p>Мы постарались сделать сайт для людей, которые хотят рассказать о своих потушествиях и
                            поделиться своими эмоциями.</p>
