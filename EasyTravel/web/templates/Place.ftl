...
<div id="page-wrap">
    ...
    <div id="wrapper">
        <div id="articles">
            <article>
                <img src="../img/pr4.png" alt="IMAGE" title="IMAGE"/>
                <h4> Путевка_1</h4>
                <p><b>Оператор:</b> Coral Travel</p>
                <p><b>Цена:</b> 322 $</p>
                <p>Это очень хороший пляж Это очень хороший пляж Это очень хороший пляж </p>
                <a href="http://www.coral.ru/" title="Купить">Подробнее</a>
            </article>
            <article>
                <img src="../img/pr4.png" alt="IMAGE" title="IMAGE"/>
                <h4> Путевка_2</h4>
