...
<div id="page-wrap">
            ...
            <div class="container-fluid">
                ...
                <#if user??>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/profile"><span class="glyphicon glyphicon-user"></span> ${user.profile.name}</a></li>
    ...
    <center>
        <div id="menu1">Посещенные места
            <hr/>
            <button type="submit" class="btn btn-default pull-right" style="margin:10px;">Реактировать</button>
        </div>
        <div id="menu2">Хочу посетить
            <hr/>
            <button type="submit" class="btn btn-default pull-right" style="margin:10px;">Редактировать</button>
        </div>
        <div id="menuHrefs">
