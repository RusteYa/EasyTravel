        ...
        <div id="articles">
            <div class="well row">
                ...
                <div class="col-lg-6 col-lg-offset-1">
                    ...
                    <br>
                    <font size="+1"><p>Логин: ${user.loginData.login}</p></font>
                    <font size="+1"><p>E-mail: ${user.loginData.email}</p></font>
                </div>
                <a type="button" href="/profilechange" class="btn btn-default pull-right" style="margin:10px;">Редактировать</a>
